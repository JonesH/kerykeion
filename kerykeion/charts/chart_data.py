...
from kerykeion.charts.charts_utils import calculate_moon_phase_chart_params
...
class KerykeionChartData(BaseModel):
    model_config = dict(
    ...
    @computed_field
    @property
    def available_kerykeion_celestial_points(self) -> List[KerykeionPointModel]:
    ...
    @computed_field
    @property
    def first_circle_radius(self) -> int:
        return 56 if self.chart_type == "ExternalNatal" else 0

    @computed_field
    @property
    def second_circle_radius(self) -> int:
        return 92 if self.chart_type == "ExternalNatal" else 36

    @computed_field
    @property
    def third_circle_radius(self) -> int:
        return 112 if self.chart_type == "ExternalNatal" else 120
    ...
    @cached_property
    def element_points(self) -> dict[str, float]:
